  ...
  if (start) {
    return (
      <div className="App">
        ...
        />
        <img className="img_ejemplo" src={require("./SignosGlobal/" + referencia + ".jpg")}></img>
        <img className="img_ejemplo" src={require("../../assets/Vimagenes/SignosGlobal/" + referencia + ".jpg")}></img>
