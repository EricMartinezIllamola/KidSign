      ...
      <div className="App">
        ...
        <div className="left_side">
          ...
          <div className="left_center">
            ...
            <img className="img_ejemplo" src={require("../../assets/alphabet_camara/" + referencia + "B.png")}></img>
          </div>
        </div>
        <div className="right_side">
          <Link to={"/Officialpage"} className="camara_l_exit"><button className="camara_exit" onClick={() => { }}>{t("Games.BtnExit")}</button></Link>
          <Link to={"/QuizzPT"} className={end? "camara_l_continue show" : "camara_l_continue"}><button className="camara_continue" onClick={() => { }}>{t("Games.BtnNext")}</button></Link>
        </div>
