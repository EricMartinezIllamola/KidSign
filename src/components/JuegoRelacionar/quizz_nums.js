    ...
    return (
        <div className="quizz_numeros">
            ...
            <div className="quizz_down">
                ...
                <Link to={'/MemoryGameglobal'} className={end? "quizz_link show" : "quizz_link"}><button className={end? "quizz_continue show" : "quizz_continue"}>{t("Games.BtnNext")}</button></Link>
            </div>
